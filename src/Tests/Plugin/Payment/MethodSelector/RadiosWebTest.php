...
/**
 * \Drupal\payment\Plugin\Payment\MethodSelector\Radios web test.
 *
 * @group Payment
 */
class RadiosWebTest extends WebTestBase {
  ...
  protected function doTestElement($tree) {
    ...
    $path = 'payment_test-payment_method_selector-advanced_payment_method_selector_base/payment_radios/' . (int) $tree;
