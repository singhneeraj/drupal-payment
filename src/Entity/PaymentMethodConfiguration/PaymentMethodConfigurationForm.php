...
class PaymentMethodConfigurationForm extends EntityForm {
  ...
  public static function create(ContainerInterface $container) {
    ...
    return new static($container->get('string_translation'), $container->get('current_user'), $entity_manager->getStorage('payment_method_configuration'), $container->get('plugin.manager.payment.method_configuration'));
  }
