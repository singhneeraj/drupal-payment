...
/**
 * @file
 * Contains \Drupal\payment\Controller\AddPaymentMethodConfiguration.
 */
...
class AddPaymentMethodConfiguration extends ControllerBase {
   ...
   */
  public function __construct(RequestStack $request_stack, TranslationInterface $string_translation, EntityManagerInterface $entity_manager, PaymentMethodConfigurationManagerInterface $payment_method_configuration_manager, EntityFormBuilderInterface $entity_form_builder, AccountInterface $current_user) {
  ...
  public static function create(ContainerInterface $container) {
    return new static($container->get('request_stack'), $container->get('string_translation'), $container->get('entity.manager'), $container->get('plugin.manager.payment.method_configuration'), $container->get('entity.form_builder'), $container->get('current_user'));
  }
  ...
  public function execute($plugin_id) {
    $payment_method_configuration = $this->entityManager->getStorage('payment_method_configuration')->create([
      'pluginId' => $plugin_id,
    ]);
