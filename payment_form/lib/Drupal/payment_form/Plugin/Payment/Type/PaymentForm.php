...
class PaymentForm extends PaymentTypeBase implements ContainerFactoryPluginInterface {
   ...
   */
  public function __construct(array $configuration, $plugin_id, array $plugin_definition, HttpKernel $http_kernel, EventDispatcherInterface $event_dispatcher, Request $request, ModuleHandlerInterface $module_handler , UrlGeneratorInterface $url_generator, EntityStorageControllerInterface $field_instance_config_storage) {
