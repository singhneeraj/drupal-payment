...
/**
 * @file
 * Contains \Drupal\Tests\payment\Unit\Entity\Payment\PaymentRefundFormTest.
 */
...
class PaymentRefundFormTest extends UnitTestCase {
  ...
  function testCreate() {
    ...
    $sut = PaymentRefundForm::create($container);
    $this->assertInstanceOf(PaymentRefundForm::class, $sut);
  }
