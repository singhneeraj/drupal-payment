...
/**
 * @file Contains \Drupal\Tests\payment\Unit\Plugin\views\filter\PaymentMethodUnitTest.
 */
...
class PaymentMethodUnitTest extends UnitTestCase {
  ...
  function testCreate() {
    ...
    $this->assertInstanceOf('\Drupal\payment\Plugin\views\filter\PaymentMethod', $sut);
  }
