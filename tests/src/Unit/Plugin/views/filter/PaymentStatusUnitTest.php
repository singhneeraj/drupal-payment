...
/**
 * @file Contains \Drupal\Tests\payment\Unit\Plugin\views\filter\PaymentStatusUnitTest.
 */
...
class PaymentStatusUnitTest extends UnitTestCase {
  ...
  function testCreate() {
    ...
    $this->assertInstanceOf('\Drupal\payment\Plugin\views\filter\PaymentStatus', $sut);
  }
