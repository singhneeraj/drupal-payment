...
/**
 * @file Contains \Drupal\Tests\payment\Unit\Plugin\views\argument_validator\ViewPaymentsByOwnerUnitTest.
 */
 ...
 * @group Payment
 */
class ViewPaymentsByOwnerUnitTest extends UnitTestCase {
  ...
  function testCreate() {
    ...
    $this->assertInstanceOf('\Drupal\payment\Plugin\views\argument_validator\ViewPaymentsByOwner', $sut);
  }
