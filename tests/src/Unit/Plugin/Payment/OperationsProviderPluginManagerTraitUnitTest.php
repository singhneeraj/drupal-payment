...
/**
 * @file
 * Contains \Drupal\Tests\payment\Unit\Plugin\Payment\Status\OperationsProviderPluginManagerTraitUnitTest.
 */
...
class OperationsProviderPluginManagerTraitUnitTest extends UnitTestCase {
  ...
  public function testGetOperationsProvider() {
    $plugin_definitions = array(
      'foo' => array(
        'id' => 'foo',
        'operations_provider' => '\Drupal\Tests\payment\Unit\Plugin\Payment\OperationsProviderPluginManagerTraitUnitTestOperationsProvider',
      ),
      'bar' => array(
        'id' => 'bar',
      ),
