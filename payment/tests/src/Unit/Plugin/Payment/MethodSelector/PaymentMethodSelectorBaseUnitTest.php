...
/**
 * @file
 * Contains \Drupal\Tests\payment\Unit\Plugin\Payment\MethodSelector\PaymentMethodSelectorBaseUnitTest.
 */
...
class PaymentMethodSelectorBaseUnitTest extends UnitTestCase {
  ...
  public function testGetAllowedPaymentMethods() {
    $ids = array($this->randomMachineName(), $this->randomMachineName());
  ...
  public function testGetAvailablePaymentMethods() {
    ...
    $plugin_id_access = $this->randomMachineName();
    ...
    $plugin_id_no_access = $this->randomMachineName();
